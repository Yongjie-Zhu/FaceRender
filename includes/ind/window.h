...
{
public:
    GLFWWindowDesc(unsigned width, unsigned height, const char* title, bool debug = false);
    ~GLFWWindowDesc();
    ...
    bool ShouldClose() const { return (1 == glfwWindowShouldClose(wptr_)) || should_close_; }
